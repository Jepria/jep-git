...
public class ${form.formName}ServerConstant extends JepRiaServerConstant {
  ...
  public static final String RESOURCE_BUNDLE_NAME = "${packagePrefix?lower_case}.${packageName?lower_case}.${moduleName?lower_case}.${form.formName?lower_case}.shared.text.${form.formName}Text";
