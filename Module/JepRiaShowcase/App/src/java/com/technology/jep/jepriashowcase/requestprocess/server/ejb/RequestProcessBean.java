...
@Local( { RequestProcessLocal.class })
@Remote( { RequestProcessRemote.class })
@StatelessDeployment
@Stateless
public class RequestProcessBean extends JepDataStandardBean implements RequestProcess {
 
	public RequestProcessBean() {
