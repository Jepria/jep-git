package com.technology.jep.jepriashowcase.request.server.ejb;
...
@Local( { RequestLocal.class })
@Remote( { RequestRemote.class })
@StatelessDeployment
@Stateless
public class RequestBean extends JepDataStandardBean implements Request {
