package com.technology.jep.jepriashowcase.requestfeature.server.dao;
...
public class RequestFeatureDao extends JepDaoStandard implements RequestFeature {
	...
	public List<JepRecord> find( JepRecord templateRecord, Mutable<Boolean> autoRefreshFlag, Integer maxRowCount, Integer operatorId) throws ApplicationException {
		return new ArrayList<JepRecord>();
//		String sqlQuery = 
//			"begin  " 
