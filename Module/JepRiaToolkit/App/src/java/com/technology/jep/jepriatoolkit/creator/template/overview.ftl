...
<html>
  <body bgcolor="white">
    ...
    <i>ant deploy -DDEPLOYMENT_PATH=&lt;DEPLOYMENT_PATH&gt; -DLOGIN=&lt;LOGIN&gt; -DPASSWORD=&lt;PASSWORD&gt; -DBIN_HOME=&lt;BIN_HOME&gt; -DLOAD_OPERATORID=&lt;LOAD_OPERATORID&gt;&nbsp;</i>, где<br/>
    <ul>
      ...
      <li>BIN_HOME - путь до бинарного репозитория
      <li>LOAD_OPERATORID - логин/пароль учетной записи в системе RFInfo, от чьего имени производится установка
    </ul>
    Пример:
    <pre>ant deploy -DDEPLOYMENT_PATH=opmn://10.90.7.148:6003/OracleAS_1.srvapp7.d.t/OC4J_4 -DPORT=8888 -DLOGIN=LOGIN -DPASSWORD=PASSWORD -DBIN_HOME=D:\SVN\JEP\Bin -DLOAD_OPERATORID=nagornyys/123<br/></pre>
