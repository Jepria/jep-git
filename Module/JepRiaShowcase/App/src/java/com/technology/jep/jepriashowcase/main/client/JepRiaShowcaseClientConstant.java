...
public class JepRiaShowcaseClientConstant extends JepRiaShowcaseConstant {
	...
	public static final String FEATUREREQUEST_MODULE_ID = "FeatureRequest";
	...
	public static final String URL_FEATUREREQUEST_MODULE = "JepRiaShowcase.jsp?em=FeatureRequest&es=sh";
